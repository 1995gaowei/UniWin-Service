...
public class WarehousePublicAction extends PageAction{
    ...
    public String getDetail()
    {
    	...
    	Vendor vendorT = vendorService.getVendorById(String.valueOf(vendorId));
    	Store storeT = warehouseService.getStore(materialCode);
    	...
    	try {
    		...
    		material.put("outputVol", materialT.getOutputVol());
    		material.put("materialTime", materialT.getModificationDate());
