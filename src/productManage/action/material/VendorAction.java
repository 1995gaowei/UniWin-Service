...
public class VendorAction extends PageAction{
	...
	public String getVendorById(){
		...
		try {
			...
			result.put("vendorOthername", vendor.getVendorOthername());
			result.put("vendorBankaccount", vendor.getVendorBankaccount());
			result.put("vendorBankaddr", vendor.getVendorBankaddr());
			result.put("vendorBankname", vendor.getVendorBankname());
			result.put("vendorTaxnumber", vendor.getVendorTaxnumber());
