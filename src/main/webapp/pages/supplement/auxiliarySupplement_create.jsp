        ...
        <aside class="right-side">
			...
			<div class="col-md-12">
				<div class="box box-primary">
							...
							<div class="box-body">
								...
								<table >
									...
									<tr>
										...
										<td><input type="text" name="materialType " disabled="true" id="materialType " value="辅料"></td>
					...
					<div class="row">
						<div class="col-md-2">
							<span size="3px" style="margin: 0px 10px 20px 20px;">辅料信息>></span>
						</div>
					</div>
        ...
        $.ajax({
        	...
        	var content = "";
          	$.each(data,function(index,item){
          		...
          		content+="<tr ondblclick='addMaterial(\""+name+"\",\""+vendor+"\",\""+supplyID+"\")' style='color:blue'><td>"+name+"</td><td>"+code
...
<script>
    var addDetail = function () {
    	...
    	var nlen = $("#tab-detail tr").length-1;
        ...
        $("#tab-detail").append("<tr id="+nlen+" align='center'>"
                ...
                +"<td><button class='btn-danger' id='delete-"+nlen+"' onclick='deltr("+nlen+")'>删除</button></td>"
                +"</tr>");
        selectMaterial(nlen);
    }
    //删除<tr/>
