        ...
        <aside class="right-side">
			...
			<div class="col-md-12">
				<div class="box box-primary">
						...
						<div class="col-md-10">
							<div class="box-body">
								...
								<table >
									...
									<tr>
										<td class="supplement-info">物料分类：</td>
										<td><input type="text" name="materialType " disabled="true" id="materialType " value="面料"></td>
					...
					<div class="row">
						<div class="col-md-2">
							<span size="3px" style="margin: 0px 10px 20px 20px; ">面料信息>></span>
						</div>
					</div>
...
function submitForm(){
	...
	var len = $("#tab-detail tr").length-1;	
	var list= "";
	if(pCode==null){		
		pCode="";	
	}
        ...
        $.ajax({
        	...
        	var content = "";
          	$.each(data,function(index,item){
          		...
          		content+="<tr ondblclick='addMaterial(\""+name+"\",\""+vendor+"\",\""+supplyID+"\")'><td>"+name+"</td><td>"+code
...
<script>
    var addDetail = function () {
        ...
        var _len = $("#tab-detail tr").length-1;

        
       
        $("#tab-detail").append("<tr id="+_len+" align='center'>"
                +"<td><input type='text' name='supplementMaterial["+ _len +"].materialName' id='detail-"+ _len +"-materialName' readonly></td>"
                +"<td><input type='text' name='supplementMaterial["+ _len +"].specification' id='detail-"+ _len +"-specification'></td>"
                +"<td><input type='text' onkeyup='this.value=this.value.replace(/\\D/g,\"\")' onafterpaste='this.value=this.value.replace(/\\D/g,\"\")' name='supplementMaterial["+ _len +"].vol' id='detail-"+ _len +"-vol' value='0'></td>"
                +"<td><input type='text' name='supplementMaterial["+ _len +"].vendor' id='detail-"+ _len +"-vendor' readonly></td>"
                +"<td><input type='text' name='supplementMaterial["+ _len +"].usage' id='detail-"+ _len +"-usage'></td>"
                +"<td><input type='hidden' name='supplementMaterial["+ _len +"].supplyID' id='detail-"+ _len +"-supplyID'></td>"
                +"<td><button class='btn-danger' id='delete-"+_len+"' onclick='deltr("+_len+")'>删除</button></td>"
                +"</tr>");
        selectMaterial(_len);
    }
    //删除<tr/>
        ...
        for (var i = index + 1, j = _len ; i < j; i++) {
            ...
            $("tr[id=\'" + i + "\']")
                    .replaceWith("<tr id=" + (i - 1) + " align='center'>"
                            ...
                            + "<td><button class='btn-danger' onclick=\'deltr(" + (i - 1) + ")\' id='delete-'"+(i-1)+">删除</button></td>"
                            + "</tr>");
        }
