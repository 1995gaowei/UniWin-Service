                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="treeview" id="10000">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <s:iterator value="#session.highMiddleAutho" id="middle">
							<s:if test="#middle.highAuthName=='物料管理'&&#middle.middleAuthName=='物料预订'">
                            <li id="10004"><a href="<%=request.getContextPath()%>/Material/showApplySelect"><i class="fa fa-angle-double-right"></i> 物料申请</a></li>
                            </s:if>
                            </s:iterator>
                            ...
                            <li id="10008"><a href="<%=request.getContextPath()%>/Bom/showDesignList"><i class="fa fa-angle-double-right"></i> 款式与物料</a></li>
                        	</s:if>
                        	</s:iterator>
                        </ul>
                    </li>
                    ...
                    <li class="treeview" id="10500">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li id="10502"><a href="<%=request.getContextPath()%>/Purchase/accessoryPurchaseList"><i class="fa fa-angle-double-right"></i> 辅料采购单管理</a></li>
                            </s:if>
                            </s:iterator>
