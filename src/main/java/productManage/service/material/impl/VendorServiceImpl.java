...
public class VendorServiceImpl implements VendorService{
	...
	@Override
	public PageBean queryVendorByMaterial(int pageSize, int page,
			Map<String, Object> params, String materialCode) {
		// TODO Auto-generated method stub
		String hql="select vendor from Vendor as vendor ,supply "; 
		
		hql += "where ";
		hql += "vendor.vendorId=supply.vendorId and supply.materialCode="+materialCode;
