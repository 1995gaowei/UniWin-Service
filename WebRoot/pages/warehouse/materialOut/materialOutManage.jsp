                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="box box-primary">
                            ...
                            <form class="form-horizontal" method="get" role="form" action="/UniWin/Warehouse/materialOut_showMaterialOutputs">
...
<script type="text/javascript">
	...
	$("#outputList tr").click(function(){
		...
		jQuery.post("/UniWin/Warehouse/materialOutputAjax_getOutputDetailByDate",params,function(data){
			objs= eval(data);  
			content = "";
