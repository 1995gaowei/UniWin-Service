         ...
         <div class="col-md-12">
               <div class="box box-primary">
                 ...
                 <table style="margin-top: 20px">
                 	<tr>
                 		<td>款号:</td>
                 		<td><input name="designCode" type="text" class="form-control form-input" value=${designCode}></td>
                 		<td>计划采购时间:</td>
                 		<td> <input name="scheduledPurchaseDate" 
                 		type="text" class="form-control form-input date" maxlength="20"></td>
                 		<td>待操作状态:</td>
                 		<td>
                 	...
                 	<tr>
                 	<td>供应商:</td>
                 	<td><input name="vendor" type="text" class="form-control form-input" value=${vendor}></td>
                 	<td>预计到货时间:</td>
                 	<td> <input name="eta" type="text" class="form-control form-input date" maxlength="20"></td>
                 	<td>新或者老款:</td>
                 	<td>
             		...
             		<td width="150px">
                 	<button type="submit" id="search-purchaselist" style="margin-top: 0px" class="btn btn-primary">查询</button>
                 	</td>
                 	</tr>
                     ...
                     <table class="table table-striped" id="materialExamineTable">
						...
						<form action="<%=request.getContextPath()%>/Purchase/changeState" method="post">
							<table class="table" rules="none" frame="void">
								<tr>
									<td >采购单号:</td>
									<td><input type="text" name="changeCode" id="changeCode1"  style="width:200px" readonly="true"></td>
									<td >状态:</td>
									<td ><input type="text" name="changeState" id="changeState1"  style="width:200px" readonly="true"></td>
				...
				<div class="modal-body">
                    <div style="word-break:break-all">
                     ...
                     <table class="table table-striped" id="chargetable">
						...
						<form action="<%=request.getContextPath()%>/Purchase/changeState1" method="post">
							<table class="table" rules="none" frame="void">
								<tr>
									<td >采购号：</td>
									<td><input type="text" name="changeCode" id="changeCode2"  style="width:200px" readonly="true"></td>
									<td >状态：</td>
									<td ><input type="text" name="changeState" id="changeState2"  style="width:200px" readonly="true"></td>
									
									<td><button  id="judgeButton" type="submit" class="btn btn-danger" style="margin:auto">
											需订购</button><input type="hidden" name="judge" id="judgeText" value="1"></td>
								</tr>
                     ...
                     <table class="table table-striped" id="chargetable">
						...
						<form action="<%=request.getContextPath()%>/Purchase/changeState" method="post">
							<table class="table" rules="none" frame="void">
								<tr>
									<td >采购单号：</td>
									<td><input type="text" name="changeCode" id="changeCode3"  style="width:200px" readonly="true"></td>
									<td >状态：</td>
									<td ><input type="text" name="changeState" id="changeState3"  style="width:200px" readonly="true"></td>
									<td >供应商：</td>
									<td ><input type="text" name="vendorID3" id="vendorID3"  style="width:200px" readonly="true"></td>
                     ...
                     <table class="table table-striped" id="chargetable">
						...
						<form action="<%=request.getContextPath()%>/Purchase/changeState" method="post">
							<table class="table" rules="none" frame="void">
								<tr>
									<td >采购单号：</td>
									<td><input type="text" name="changeCode" id="changeCode4"  style="width:200px" readonly="true"></td>
									<td >状态：</td>
									<td ><input type="text" name="changeState" id="changeState4"  style="width:200px" readonly="true"></td>
                     ...
                     <table class="table table-striped" id="chargetable">
						...
						<form action="<%=request.getContextPath()%>/Purchase/changeState" method="post">
							<table class="table" rules="none" frame="void">
								<tr>
									<td >采购单号：</td>
									<td><input type="text" name="changeCode" id="changeCode5"  style="width:200px" readonly="true"></td>
									<td >状态：</td>
									<td ><input type="text" name="changeState" id="changeState5"  style="width:200px" readonly="true"></td>
                     ...
                     <table class="table table-striped" id="chargetable">
						...
						<form action="<%=request.getContextPath()%>/Purchase/changeState" method="post">
							<table class="table" rules="none" frame="void">
								<tr>
									<td >采购单号：</td>
									<td><input type="text" name="changeCode" id="changeCode6"  style="width:200px" readonly="true"></td>
									<td >状态：</td>
									<td ><input type="text" name="changeState" id="changeState6"  style="width:200px" readonly="true"></td>
        	...
        	function warehouseCheck(){
        		...
        		if(selectedID != null){
        			if( selectedState == "待库存审核"){
        				...
        				if(selectedPurchaseVol<=0){
        					document.getElementById("judgeButton").innerHTML="完成采购";
        					document.getElementById("judgeText").value="2";   					
        				}
        			}else{
        				alert("该补料单并非待库存审核状态");
        			}       			        			
