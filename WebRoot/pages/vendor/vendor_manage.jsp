					...
					<div class="table" style="margin-top: 10px;">
						...
						<form action="<%=request.getContextPath()%>/Vendor/addVendor" method="post">
							<table class="table" rules="none" frame="void">
								...
								<tr>
								<td>供应商别名<span style="color: red"></span>：
								</td>
									<td><input type="text" name="new_otherName"></td>
								<td>供应商纳税识别号<span style="color: red"></span>：
								</td>
									<td><input type="text" name="new_taxNumber"></td>
								</tr>
								<tr>
								<td>供应商开户行<span style="color: red">*</span>：
								</td>
									<td><input type="text" name="new_bankName"></td>
								<td>供应商开户行帐号<span style="color: red">*</span>：
								</td>
									<td><input type="text" name="new_bankAccount"></td>
								</tr>
								<tr>
								<td>开户行地址*<span style="color: red">*</span>：
								</td>
									<td colspan="3"><input type="text" style="width: 90%" name="new_bankAddr"></td>
								</tr>
								<tr>
						...
						<form action="<%=request.getContextPath()%>/Vendor/updateVendor" method="post">
							<table class="table" rules="none" frame="void">
								...
								<td>供应商别名<span style="color: red"></span>：
									...
									<td><input type="text" id="update_otherName" name="update_otherName"></td>
								<td>供应商纳税识别号<span style="color: red"></span>：
								</td>
									<td><input type="text" id="update_taxNumber" name="update_taxNumber"></td>
								</tr>
								<tr>
								<td>供应商开户行<span style="color: red">*</span>：
								</td>
									<td><input type="text" id="update_bankName" name="update_bankName"></td>
								<td>供应商开户行帐号<span style="color: red">*</span>：
								</td>
									<td><input type="text" id="update_bankAccount" name="update_bankAccount"></td>
								</tr>
								<tr>
								<td>开户行地址*<span style="color: red">*</span>：
								</td>
									<td colspan="3"><input type="text" style="width: 90%" id="update_bankAddr" name="update_bankAddr"></td>
								</tr>
								<tr>
									<td>供应商地址<span style="color: red">*</span>：
									</td>
